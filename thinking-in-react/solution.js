...
export const SearchBar = React.createClass({
    ...
    render() {
        ...
        return (
            <form>
                <input ref={(r) => this.filterText = r} type="search" placeholder="Search..." value={filterText} onChange={this.handleChange}/>
                <label>
                    <input ref={(r) => this.inStockOnly = r} type="checkbox" checked={inStockOnly} onChange={this.handleChange}/>
